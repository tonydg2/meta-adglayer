...
if [ -z $width ] || [ -z $height ]
then
    echo "WARNING: output resolution not set: using default '1920x1080' resolution";
    width=1920
    height=1080
fi
...
##MEDIA_DEV=/dev/$(ls /sys/devices/platform/amba_pl@0/amba_pl@0\:vcap_v_proc_ss_scaler_0/ | grep media)
##VIDEO_DEV=/dev/$(ls /sys/devices/platform/amba_pl@0/amba_pl@0\:vcap_v_proc_ss_scaler_0/video4linux/ | grep video)
